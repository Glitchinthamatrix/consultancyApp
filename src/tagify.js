...
(function(root, factory) {
    ...
    Tagify.prototype = {
        ...
        loadOriginalValues: function loadOriginalValues(value) {
            ...
            if (!value) return;
            this.removeAllTags();
            if (this.settings.mode == 'mix') this.parseMixTags(value.trim());
            else {
                try {
            ...
            callbacks: {
                            ...
                            case 'Backspace':
                                {
                                    ...
                                    setTimeout(function() {
                                        ...
                                        _this4.value = [].map.call(lastTagElems, function(node, nodeIdx) {
                                            ...
                                            if (node.parentNode) return tagData;
                                            else _this4.trigger('remove', {
                                                tag: node,
                                                index: nodeIdx,
                                                data: tagData
                                            });
                        ...
                        case 'Backspace':
                            if (!this.state.dropdown.visible) {
                                if (s == "" || s.charCodeAt(0) == 8203) {
                                    ...
                                    if (this.settings.backspace === true) this.removeTag();
                ...
                onClickScope: function onClickScope(e) {
                    ...
                    if (e.target == this.DOM.scope) {
                        ...
                        if (this.state.dropdown.visible) this.dropdown.hide.call(this);
                        else if (_s.dropdown.enabled === 0 && _s.mode != 'mix') this.dropdown.show.call(this);
                        return;
                    }
        ...
        input: {
            ...
            validate: function validate() {
                ...
                if (this.settings.mode == 'select') this.DOM.scope.classList.toggle('tagify--invalid', isValid !== true);
                else this.DOM.input.classList.toggle('tagify__input--invalid', isValid !== true);
            },
        ...
        validateTag: function validateTag(tagData) {
            ...
            else if (!_s.duplicates && this.isTagDuplicate(value)) result = this.TEXTS.duplicate;
            else if (this.isTagBlacklisted(value) || _s.enforceWhitelist && !this.isTagWhitelisted(value)) result = this.TEXTS.notAllowed;
            return result;
        },
        ...
        selectTag: function selectTag(tagElm, tagData) {
            ...
            if (this.getLastTag()) this.replaceTag(this.getLastTag(), tagData);
        ...
        removeAllTags: function removeAllTags() {
            ...
            else Array.prototype.slice.call(this.getTagElms()).forEach(function(elm) {
